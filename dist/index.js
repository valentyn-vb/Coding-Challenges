...
function sortString(value) {
    ...
    res.map((word) => {
        ...
        const index = letters.find((letter) => !!Number(letter));
...
const findTheMissingLetter = (arr) => {
    const findRegister = arr[0] === arr[0].toUpperCase() ? "toUpperCase" : "toLowerCase";
    let missingLetter = "";
    const findFirstLetterIndex = alphabet.findIndex((el) => el === arr[0].toUpperCase());
    const findLastLetterIndex = alphabet.findIndex((el) => el === arr[arr.length - 1].toUpperCase());
    const updateAlp = alphabet.slice(findFirstLetterIndex, findLastLetterIndex + 1);
    updateAlp.map((el) => {
...
console.log('Expected: "Jacob and Alex like this", Real:', generateMessage(["Jacob", "Alex"]));
console.log('Expected: "Max, John and Mark like this", Real:', generateMessage(["Max", "John", "Mark"]));
console.log('Expected: "Alex, Jacob and 2 others like this", Real:', generateMessage(["Alex", "Jacob", "Mark", "Max"]));
